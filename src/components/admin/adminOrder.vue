<template>
    <div class="admin-add-order">
        ...
        <!--order detail -->
        <adminOrderDetail v-if="activeDetail" :id="id" :paymentSuccess="paymentSuccess" @close-detail="closeDetail" @close-success="closeSuccess"></adminOrderDetail>
        <!-- pagination -->
...
import templateOrder from '@/utils/templateOrder'
import productService from '@/service/product.service';
import print from '@/utils/print'
import printTemlateOrder from '@/utils/printTemplateOrder'
export default {
    components:{
        adminOrderDetail
    },
    ...
    methods:{
        ...
        exportToExcel() {
            ...
            exportToExcel(data, 'DonHang');
        },
        async exportToPDF(){
            const data= templateOrder(this.orders)
            ...
            link.href = url;
            link.target = '_blank';
            link.setAttribute('download', 'DonHang.pdf');
        ...
        async printPDF(id){
            ...
            order.createdAt = format.formatDate(order.createdAt)
                ...
                order.VAT= format.formatCurrency( order.VAT)
            ...
            const printTemplate= printTemlateOrder(order)
