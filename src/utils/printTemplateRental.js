   ...
   <div style="height:100%">
        ...
        <div style="width: 100%;">
            <div style="font-size: 20px; margin-right: 10px; display: flex; flex-direction: column; align-items: flex-end; justify-content: flex-start;">
                <span style="margin-bottom:10px"><b>Tổng giá sản phẩm</b>: ${info.totalCostOfProducts}</span>
                <span style="margin-bottom:10px"><b>Phí vận chuyển</b>: ${info.transportFee}</span>
                <span style="margin-bottom:10px"><b>Tổng cộng</b>: ${format.formatCurrency(info.totalAmount)}</span>
                <span style="margin-bottom:10px"><b>Số tiền phải thu</b>: ${info.isPayment ? format.formatCurrency(0): format.formatCurrency(info.totalAmount)}</span>
            </div>
        </div>
